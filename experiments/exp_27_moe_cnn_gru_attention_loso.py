"""
Experiment 27: Subject-as-Domain Mixture-of-Experts CNN-GRU-Attention (LOSO)

Hypothesis H1: Each EMG subject is a separate domain. A unified model is suboptimal.
MoE with signal-style gating (amplitude profile, spectral density, SNR) models
subject-specific signal characteristics as a latent routing factor, yielding better
cross-subject generalization than a standard CNN-GRU-Attention baseline.

Architecture: Shared CNN backbone + 4 expert GRU-Attention heads + Signal Gating Network
Baseline comparison: exp_1 (CNN-GRU-Attention, deep_raw)
"""
...
# Import and register MoE model
from models.moe_cnn_gru_attention import MoECNNGRUAttention
from models import register_model
register_model("moe_cnn_gru_attention", MoECNNGRUAttention)
...
def main():
    ...
    global_logger.info(f"Hypothesis: H1 — Subject-as-Domain MoE")
