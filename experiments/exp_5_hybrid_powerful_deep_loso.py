...
def main():
    EXPERIMENT_NAME = "exp5_hybrid_powerful_deep_loso"
    BASE_DIR = ROOT / "data"
    ...
    MODEL_TYPES = ["hybrid_powerful_deep"]  # одна архитектура
    ...
    train_cfg = TrainingConfig(
        ...
        hybrid_use_domain_adaptation=True,
        hybrid_domain_loss_weight=0.2,
        hybrid_num_domains=2,
        hybrid_grl_lambda=1.0,
    ...
    for model_type in MODEL_TYPES:
        print(f"MODEL: {model_type} — starting LOSO (hybrid_powerful_deep)")
